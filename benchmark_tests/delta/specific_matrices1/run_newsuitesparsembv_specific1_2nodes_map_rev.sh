#!/bin/bash
#SBATCH --job-name run_newsuitesparsembv_specific1_2nodes_map_rev
...
mpirun --map-by ppr:1:numa --bind-to numa --rank-by slot --display-map --display-allocation --report-bindings ./new_gpuaware_gpu_suitesparse_neighbor_alltoallv_matblockvec r $SPECIFIC_MATS
...
mpirun --map-by ppr:1:numa --bind-to numa --rank-by slot --display-map --display-allocation --report-bindings ./new_gpuaware_gpu_suitesparse_threaded_neighbor_alltoallv_matblockvec r $SPECIFIC_MATS
